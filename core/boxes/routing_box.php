 ...
 */
class routingbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "routing@routing";
    public $boxlabel;
    public $depends = array("routing");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/routing/class/routing.class.php";
